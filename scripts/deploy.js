...
console.log(`   Frontend URL: http://${frontendUrl}`);

// Step 3: Update Terraform CORS & Redirect URL with Frontend Bucket URL
console.log('\n🔄 Updating Terraform CORS for Frontend S3 Domain...');
execSync(`terraform apply -var="frontend_domain=http://${frontendUrl}" -auto-approve`, { cwd: terraformDir, stdio: 'inherit', env });
...
console.log(`🌐 Frontend Web App URL: http://${frontendUrl}`);
